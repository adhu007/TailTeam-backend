        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Degree = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    About = table.Column<string>(type: "nvarchar(250)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlotBookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SlotBookings_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SlotBookings_Consultants_ConsultantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMode = table.Column<string>(type: "nvarchar(50)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentDetails_SlotBookings_SlotBookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetails_SlotBookingId",
                table: "PaymentDetails",
                column: "SlotBookingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SlotBookings_ConsultantId_SlotTime",
                table: "SlotBookings",
                columns: new[] { "ConsultantId", "SlotTime" },
                unique: true);
